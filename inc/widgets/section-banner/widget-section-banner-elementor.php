    ...
    class Alpus_Section_Banner_Elementor_Widget_Addon extends Alpus_Base {
        ...
        public function add_section_controls( $self, $condition_value ) {
            ...
            $self->add_control(
                ...
                array(
                    'description' => sprintf( esc_html__( '%1$s%2$sNote:%3$s Use %2$schild columns%3$s as %2$sbanner layer%3$s by using %2$s%4$s%3$s settings%5$s', 'alpus-core' ), '<span class="important-note">', '<b>', '</b>', ALPUS_DISPLAY_NAME, '</span>' ),
                    'type'        => 'description',
                    'condition'   => array(
                        $condition_value => 'banner',
                    ),
            ...
            if ( 'banner' == $settings['use_as'] ) { // if using as banner
                ...
                if ( 'banner' == $settings['use_as'] && isset( $settings['banner_background_image'] ) ) {
					...
					<figure class="banner-img">
                        ...
                        ?>
						<figure class="banner-img">
							<?php echo '<img src="' . esc_url( $settings['banner_background_image']['url'] ) . '" alt="' . esc_html__( 'Default Image', 'alpus-core' ) . '" width="1400" height="753"' . ( $settings['banner_background_color'] ? ( ' style="background-color:' . $settings['banner_background_color'] ) . '"' : '' ) . '>'; ?>
						</figure>
						<?php
                    }
                }

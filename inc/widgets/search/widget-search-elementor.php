    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'disabledOptions' => array( 'fullscreen' ),
                'condition'       => array(
                    'type' => 'toggle',
                ),
            )
        ...
        Alpus_Core_Elementor_Extend::upgrade_pro_notice(
            $this,
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'        => Controls_Manager::COLOR,
                'selectors'   => array(
                    '.elementor-element-{{ID}} .hs-dropdown .btn-search, .elementor-element-{{ID}} .hs-dropdown .form-control, .elementor-element-{{ID}} .hs-dropdown .select-box' => 'background-color: {{VALUE}};',
                ),
                'condition'   => array(
                    'type'        => 'toggle',
                    'toggle_type' => 'dropdown',
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'qa_selector' => '.search-wrapper input.form-control',
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'qa_selector' => '.search-wrapper .btn-search',
            )
        );
        $this->add_responsive_control(
            'icon_size',

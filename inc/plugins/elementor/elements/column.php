...
class Alpus_Element_Column extends Elementor\Element_Column {
    ...
    protected function register_controls() {
        ...
        Alpus_Core_Elementor_Extend::upgrade_pro_notice( $this, Controls_Manager::RAW_HTML, 'column', 'sticky_column', array( 'sticky_column' => 'yes' ) );
    ...
    protected function content_template() {
        ...
        ?>
			...
			<# } else { #>
				...
				<div class="elementor-<?php echo alpus_escaped( $wrapper_element ); ?>-wrap" {{{ wrapper_attrs }}}>

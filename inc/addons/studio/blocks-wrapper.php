		...
		<div class="blocks-section-content">
			<div class="blocks-section-pane active" id="studio-section">
				<div class="category-list">
					...
					<h3>
						<figure>
							<img src="<?php echo ALPUS_CORE_URI; ?>/assets/images/logo-studio.png" alt="<?php printf( esc_attr__( '%s Studio', 'alpus-core' ), ALPUS_DISPLAY_NAME ); ?>" width="163" height="120" />
						</figure>
					</h3>
			<div class="demo-filter">
				<form action="#" class="input-wrapper">
					<input type="search" name="search" placeholder="<?php esc_attr_e( 'Search Your Keyword...', 'alpus-core' ); ?>" />
                    ...
                    if ( in_array( $big_category, $args['has_children'] ) ) {
                        ...
                        foreach ( $args['categories'] as $category ) {
                            if ( in_array( $category['title'], $args[ $big_category . '_categories' ] ) && $category['count'] > 0 ) {
                                ?>
							<li data-li="<?php echo esc_attr( $category['title'] ); ?>">

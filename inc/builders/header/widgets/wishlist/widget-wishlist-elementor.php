...
class Alpus_Header_Wishlist_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        Alpus_Core_Elementor_Extend::upgrade_pro_notice( $this, Controls_Manager::RAW_HTML, 'wishlist', 'miniwishlist', array( 'miniwishlist' => 'offcanvas' ) );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Wishlist Toggle', 'alpus-core' ),

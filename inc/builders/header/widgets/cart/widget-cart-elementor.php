...
class Alpus_Header_Cart_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        Alpus_Core_Elementor_Extend::upgrade_pro_notice( $this, Controls_Manager::RAW_HTML, 'cart', 'mini_cart', array( 'mini_cart' => 'offcanvas' ) );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'        => Controls_Manager::COLOR,
                'selectors'   => array(
                    '{{WRAPPER}} .cart-dropdown:hover .offcanvas-open' => 'color: {{VALUE}};',
                ),
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'selector'  => '.elementor-element-{{ID}} .cart-dropdown .cart-toggle .cart-price',
                'condition' => array(
                    'show_price' => 'yes',
                ),
            )
        ...
        $this->add_responsive_control(
            'cart_price_space',
            array(
                'label'       => esc_html__( 'Price Space (px)', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => array( 'px' ),
                'selectors'   => array(
                    '.elementor-element-{{ID}} .cart-dropdown .cart-label .cart-name' => 'margin-bottom: {{SIZE}}px;',
                ),
                'condition'   => array(
                    'show_label' => 'yes',
                    'show_price' => 'yes',
                ...
                'description' => esc_html__( 'Controls the space between cart text and icon.', 'alpus-core' ),
            )
        );

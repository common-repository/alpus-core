...
if ( ! class_exists( 'Alpus_Core_UniCPO' ) ) {
    /**
     * Alpus UniCPO Class
     */
    class Alpus_Core_UniCPO extends Alpus_Base {
        ...
        public function enqueue_style() {
            wp_enqueue_style( 'alpus-unicpo-style', alpus_core_framework_uri( '/plugins/unicpo/unicpo' . ( is_rtl() ? '-rtl' : '' ) . '.min.css' ), array( 'alpus-theme' ), ALPUS_CORE_VERSION );
        }
    }
}

Alpus_Core_UniCPO::get_instance();

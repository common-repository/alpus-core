const AlpusStyleOptionsControl = function ( {
	label,
	value,
	options,
	onChange
	...
	return (
		<>
			<PanelBody title={ label } initialOpen={ false }>
				{ bgEnabled && (
					<div className="alpus-typography-control alpus-dimension-control">
								...
								return (
									<div>
										...
										<IconButton
											...
											label={ __( 'Change image', 'alpus-core' ) }
											icon="edit"
											onClick={ open }
										/>
										<IconButton
						...
						{ value.bg && value.bg.img_id && (
							<SelectControl
								label={ __( 'Position', 'alpus-core' ) }
								value={ value.bg && value.bg.position }
								options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'Center Center', 'alpus-core' ), value: 'center center' }, { label: __( 'Center Left', 'alpus-core' ), value: 'center left' }, { label: __( 'Center Right', 'alpus-core' ), value: 'center right' }, { label: __( 'Top Center', 'alpus-core' ), value: 'top center' }, { label: __( 'Top Left', 'alpus-core' ), value: 'top left' }, { label: __( 'Top Right', 'alpus-core' ), value: 'top right' }, { label: __( 'Bottom Center', 'alpus-core' ), value: 'bottom center' }, { label: __( 'Bottom Left', 'alpus-core' ), value: 'bottom left' }, { label: __( 'Bottom Right', 'alpus-core' ), value: 'bottom right' } ] }
								onChange={ ( val ) => {
									if ( !value.bg ) {
										value.bg = {};
									}
						...
						{ value.bg && value.bg.img_id && (
							<SelectControl
								label={ __( 'Attachment', 'alpus-core' ) }
								value={ value.bg && value.bg.attachment }
								options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'Scroll', 'alpus-core' ), value: 'scroll' }, { label: __( 'Fixed' ), value: 'fixed' } ] }
								onChange={ ( val ) => {
									if ( !value.bg ) {
										value.bg = {};
									}
						...
						{ value.bg && value.bg.img_id && (
							<SelectControl
								label={ __( 'Repeat', 'alpus-core' ) }
								value={ value.bg && value.bg.repeat }
								options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'No-repeat', 'alpus-core' ), value: 'no-repeat' }, { label: __( 'Repeat', 'alpus-core' ), value: 'repeat' }, { label: __( 'Repeat-x', 'alpus-core' ), value: 'repeat-x' }, { label: __( 'Repeat-y', 'alpus-core' ), value: 'repeat-y' } ] }
								onChange={ ( val ) => {
									if ( !value.bg ) {
										value.bg = {};
									}
						...
						{ value.bg && value.bg.img_id && (
							<SelectControl
								...
								options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'Auto', 'alpus-core' ), value: 'auto' }, { label: __( 'Cover', 'alpus-core' ), value: 'cover' }, { label: __( 'Contain', 'alpus-core' ), value: 'contain' } ] }
								onChange={ ( val ) => {
									if ( !value.bg ) {
										value.bg = {};
									}
				...
				{ borderEnabled && (
					<div className="alpus-typography-control alpus-dimension-control">
						<h3 className="components-base-control" style={ { marginBottom: 15 } }>
							{ __( 'Border', 'alpus-core' ) }
						</h3>
						<SelectControl
							label={ __( 'Style', 'alpus-core' ) }
						...
						<div style={ { display: 'flex', flexWrap: 'wrap' } }>
							...
							<label style={ { width: '100%', marginTop: 10, marginBottom: 5 } }>
								{ __( 'Color', 'alpus-core' ) }
								<span className="alpus-color-show" style={ { backgroundColor: value.border && value.border.color } }>
								</span>
							</label>
							<ColorPicker
								label={ __( 'Color', 'alpus-core' ) }
				...
				{ positionEnabled && (
					<div className="alpus-typography-control alpus-dimension-control">
						<h3 className="components-base-control" style={ { marginBottom: 15 } }>
							{ __( 'Position', 'alpus-core' ) }
						</h3>
						<SelectControl
							label={ __( 'Style', 'alpus-core' ) }
							value={ value.position && value.position.style }
							options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'Static', 'alpus-core' ), value: 'static' }, { label: __( 'Relative', 'alpus-core' ), value: 'relative' }, { label: __( 'Absolute', 'alpus-core' ), value: 'absolute' }, { label: __( 'Fixed', 'alpus-core' ), value: 'fixed' }, { label: __( 'Sticky', 'alpus-core' ), value: 'sticky' } ] }
							onChange={ ( val ) => {
								if ( !value.position ) {
									value.position = {};
								}
						...
						<SelectControl
							...
							options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'Full Width (100%)', 'alpus-core' ), value: '100%' }, { label: __( 'Inline (auto)', 'alpus-core' ), value: 'auto' }, { label: __( 'Fit Content', 'alpus-core' ), value: 'fit-content' }, { label: __( 'Custom', 'alpus-core' ), value: 'custom' } ] }
							onChange={ ( val ) => {
								if ( !value.position ) {
									value.position = {};
								}
						...
						<SelectControl
							...
							help={ __( 'This only works in flex container or with width property together.', 'alpus-core' ) }
							value={ value.position && value.position.halign }
							options={ [ { label: __( 'Default', 'alpus-core' ), value: '' }, { label: __( 'Center', 'alpus-core' ), value: 'x' }, { label: __( 'Left', 'alpus-core' ), value: 'e' }, { label: __( 'Right', 'alpus-core' ), value: 's' } ] }
							onChange={ ( val ) => {
								if ( !value.position ) {
									value.position = {};
								}
				...
				{ transformEnabled && (
					<div className="alpus-typography-control alpus-dimension-control">
						<h3 className="components-base-control" style={ { marginBottom: 15 } }>
							{ __( 'Transform', 'alpus-core' ) }
						</h3>

						<ToggleControl
							label={ __( 'Translate', 'alpus-core' ) }
						...
						<ToggleControl
							label={ __( 'Flip Horizontal', 'alpus-core' ) }
						...
						/>
						<ToggleControl
							label={ __( 'Flip Vertical', 'alpus-core' ) }
				...
				{ boxShadowEnabled && (
					<div className="alpus-typography-control alpus-dimension-control">
						<h3 className="components-base-control" style={ { marginBottom: 15 } }>
							{ __( 'Box Shadow', 'alpus-core' ) }
						</h3>
						<SelectControl
							label={ __( 'Type', 'alpus-core' ) }
							value={ value.boxshadow && value.boxshadow.type }
							options={ [ { label: __( 'Outset', 'alpus-core' ), value: '' }, { label: __( 'Inset', 'alpus-core' ), value: 'inset' }, { label: __( 'None', 'alpus-core' ), value: 'none' }, { label: __( 'Inherit', 'alpus-core' ), value: 'inherit' } ] }
							onChange={ ( val ) => {
								if ( ! value.boxshadow ) {
									value.boxshadow = {};
								}
				...
				{ visibilityEnabled && (
					<div className="alpus-typography-control alpus-dimension-control">
						<h3 className="components-base-control" style={ { marginBottom: 15 } }>
							{ __( 'Visibility', 'alpus-core' ) }
						</h3>
						<p className="help">{ __( 'Visibility will take effect only on live page.', 'alpus-core' ) }</p>
						<ToggleControl
							label={ __( 'Hide On Large Desktop', 'alpus-core' ) }
						...
						/>
						<ToggleControl
							label={ __( 'Hide On Desktop', 'alpus-core' ) }
						...
						/>
						<ToggleControl
							label={ __( 'Hide On Tablet', 'alpus-core' ) }
						...
						/>
						<ToggleControl
							label={ __( 'Hide On Mobile', 'alpus-core' ) }
			...
			{ options && options.hoverOptions && (
				<PanelBody title={ __( 'Hover Style Options', 'alpus-core' ) } initialOpen={ false }>
					<div className="alpus-typography-control alpus-dimension-control">
						...
						<p style={ { marginBottom: 4, width: '100%' } }>
							{ __( 'Text Color', 'alpus-core' ) }
							<span className="alpus-color-show" style={ { backgroundColor: value.hover && value.hover.color } }>
							</span>
						</p>
						<ColorPalette
							label={ __( 'Text Color', 'alpus-core' ) }
						...
						<label style={ { width: '100%', marginTop: 10, marginBottom: 5 } }>
							...
							<span className="alpus-color-show" style={ { backgroundColor: value.hover && value.hover.border_color } }>
							</span>
						</label>
						<ColorPicker
							label={ __( 'Color', 'alpus-core' ) }
					...
					{ transformEnabled && (
						<div className="alpus-typography-control alpus-dimension-control">
							...
							/>
							<RangeControl
								label={ __( 'Transition Duration (ms)', 'alpus-core' ) }
...
export default AlpusStyleOptionsControl;

export const alpusGenerateStyleOptionsCSS = function ( style_options, selector ) {
	var css = '';
	if ( !style_options ) {
		return '';
	}
...
export const alpusGenerateStyleOptionsClass = function ( style_options ) {
	var visibilityClass = '';
	if ( !style_options ) {
		return '';
	}

...
if ( ! empty( $settings['bg'] ) || ! empty( $settings['border'] ) || ! empty( $settings['padding'] ) || ! empty( $settings['margin'] ) || ! empty( $settings['position'] ) || ! empty( $settings['borderRadius'] ) || ! empty( $settings['transform'] ) || ! empty( $settings['boxshadow'] ) ) {
    echo 'html ' . esc_html( sanitize_text_field( $settings['selector'] ) ) . '{';

    if ( ! empty( $settings['bg'] ) ) {
        if ( ! empty( $settings['bg']['color'] ) ) {
            echo 'background-color:' . esc_html( sanitize_text_field( $settings['bg']['color'] ) ) . ';';
        }
        ...
        if ( ! empty( $settings['bg']['position'] ) ) {
            echo 'background-position:' . esc_html( sanitize_text_field( $settings['bg']['position'] ) ) . ';';
        }

        if ( ! empty( $settings['bg']['attachment'] ) ) {
            echo 'background-attachment:' . esc_html( sanitize_text_field( $settings['bg']['attachment'] ) ) . ';';
        }

        if ( ! empty( $settings['bg']['repeat'] ) ) {
            echo 'background-repeat:' . esc_html( sanitize_text_field( $settings['bg']['repeat'] ) ) . ';';
        }

        if ( ! empty( $settings['bg']['size'] ) ) {
            echo 'background-size:' . esc_html( sanitize_text_field( $settings['bg']['size'] ) ) . ';';
        }
    }

    if ( ! empty( $settings['border'] ) ) {
        if ( ! empty( $settings['border']['style'] ) ) {
            echo 'border-style:' . esc_html( sanitize_text_field( $settings['border']['style'] ) ) . ';';
        }
        ...
        if ( isset( $settings['border']['top'], $settings['border']['right'], $settings['border']['bottom'], $settings['border']['left'] ) && strlen( $settings['border']['top'] ) && strlen( $settings['border']['right'] ) && strlen( $settings['border']['bottom'] ) && strlen( $settings['border']['left'] ) ) {
            echo 'border-width:' . esc_html( sanitize_text_field( $settings['border']['top'] . ' ' . $settings['border']['right'] . ' ' . $settings['border']['bottom'] . ' ' . $settings['border']['left'] ) ) . ';';
        } else {
            if ( isset( $settings['border']['top'] ) && strlen( $settings['border']['top'] ) ) {
                echo 'border-top-width:' . esc_html( sanitize_text_field( $settings['border']['top'] ) ) . ';';
            }

            if ( isset( $settings['border']['right'] ) && strlen( $settings['border']['right'] ) ) {
                echo 'border-right-width:' . esc_html( sanitize_text_field( $settings['border']['right'] ) ) . ';';
            }

            if ( isset( $settings['border']['bottom'] ) && strlen( $settings['border']['bottom'] ) ) {
                echo 'border-bottom-width:' . esc_html( sanitize_text_field( $settings['border']['bottom'] ) ) . ';';
            }

            if ( isset( $settings['border']['left'] ) && strlen( $settings['border']['left'] ) ) {
                echo 'border-left-width:' . esc_html( sanitize_text_field( $settings['border']['left'] ) ) . ';';
            }
        }

        if ( ! empty( $settings['border']['color'] ) ) {
            echo 'border-color:' . esc_html( sanitize_text_field( $settings['border']['color'] ) ) . ';';
        }
    }
    ...
    if ( ! empty( $settings['borderRadius'] ) ) {
        if ( isset( $settings['borderRadius']['top'], $settings['borderRadius']['right'], $settings['borderRadius']['bottom'], $settings['borderRadius']['left'] ) && strlen( $settings['borderRadius']['top'] ) && strlen( $settings['borderRadius']['right'] ) && strlen( $settings['borderRadius']['bottom'] ) && strlen( $settings['borderRadius']['left'] ) ) {
            echo 'border-radius:' . esc_html( sanitize_text_field( $settings['borderRadius']['top'] . ' ' . $settings['borderRadius']['right'] . ' ' . $settings['borderRadius']['bottom'] . ' ' . $settings['borderRadius']['left'] ) ) . ';';
        } else {
            if ( isset( $settings['borderRadius']['top'] ) && strlen( str_replace( array( 'px', '%', 'em', 'rem', 'vw', 'vh' ), '', $settings['borderRadius']['top'] ) ) ) {
                echo 'border-top-left-radius:' . esc_html( sanitize_text_field( $settings['borderRadius']['top'] ) ) . ';';
            }

            if ( isset( $settings['borderRadius']['right'] ) && strlen( str_replace( array( 'px', '%', 'em', 'rem', 'vw', 'vh' ), '', $settings['borderRadius']['right'] ) ) ) {
                echo 'border-top-right-radius:' . esc_html( sanitize_text_field( $settings['borderRadius']['right'] ) ) . ';';
            }

            if ( isset( $settings['borderRadius']['bottom'] ) && strlen( str_replace( array( 'px', '%', 'em', 'rem', 'vw', 'vh' ), '', $settings['borderRadius']['bottom'] ) ) ) {
                echo 'border-bottom-right-radius:' . esc_html( sanitize_text_field( $settings['borderRadius']['bottom'] ) ) . ';';
            }

            if ( isset( $settings['borderRadius']['left'] ) && strlen( str_replace( array( 'px', '%', 'em', 'rem', 'vw', 'vh' ), '', $settings['borderRadius']['left'] ) ) ) {
                echo 'border-bottom-left-radius:' . esc_html( sanitize_text_field( $settings['borderRadius']['left'] ) ) . ';';
            }
        }
    }
    ...
    if ( ! empty( $settings['margin'] ) ) {
        if ( ! empty( $settings['margin']['top'] ) && ! empty( $settings['margin']['right'] ) && ! empty( $settings['margin']['bottom'] ) && ! empty( $settings['margin']['left'] ) ) {
            echo 'margin:' . esc_html( sanitize_text_field( $settings['margin']['top'] . ' ' . $settings['margin']['right'] . ' ' . $settings['margin']['bottom'] . ' ' . $settings['margin']['left'] ) ) . ';';
        } else {
            if ( ! empty( $settings['margin']['top'] ) ) {
                echo 'margin-top:' . esc_html( sanitize_text_field( $settings['margin']['top'] ) ) . ';';
            }

            if ( ! empty( $settings['margin']['right'] ) ) {
                echo 'margin-right:' . esc_html( sanitize_text_field( $settings['margin']['right'] ) ) . ';';
            }

            if ( ! empty( $settings['margin']['bottom'] ) ) {
                echo 'margin-bottom:' . esc_html( sanitize_text_field( $settings['margin']['bottom'] ) ) . ';';
            }

            if ( ! empty( $settings['margin']['left'] ) ) {
                echo 'margin-left:' . esc_html( sanitize_text_field( $settings['margin']['left'] ) ) . ';';
            }
        }
    }
    ...
    if ( ! empty( $settings['padding'] ) ) {
        if ( ! empty( $settings['padding']['top'] ) && ! empty( $settings['padding']['right'] ) && ! empty( $settings['padding']['bottom'] ) && ! empty( $settings['padding']['left'] ) ) {
            echo 'padding:' . esc_html( sanitize_text_field( $settings['padding']['top'] . ' ' . $settings['padding']['right'] . ' ' . $settings['padding']['bottom'] . ' ' . $settings['padding']['left'] ) ) . ';';
        } else {
            if ( ! empty( $settings['padding']['top'] ) ) {
                echo 'padding-top:' . esc_html( sanitize_text_field( $settings['padding']['top'] ) ) . ';';
            }

            if ( ! empty( $settings['padding']['right'] ) ) {
                echo 'padding-right:' . esc_html( sanitize_text_field( $settings['padding']['right'] ) ) . ';';
            }

            if ( ! empty( $settings['padding']['bottom'] ) ) {
                echo 'padding-bottom:' . esc_html( sanitize_text_field( $settings['padding']['bottom'] ) ) . ';';
            }

            if ( ! empty( $settings['padding']['left'] ) ) {
                echo 'padding-left:' . esc_html( sanitize_text_field( $settings['padding']['left'] ) ) . ';';
            }
        }
    }
    ...
    if ( ! empty( $settings['position'] ) ) {
        ...
        if ( ( isset( $settings['position']['translatex'] ) && strlen( $settings['position']['translatex'] ) ) || ( isset( $settings['position']['translatey'] ) && strlen( $settings['position']['translatey'] ) ) ) {
            ...
            if ( isset( $settings['position']['translatex'] ) && strlen( $settings['position']['translatex'] ) ) {
                echo ' translateX(' . esc_html( sanitize_text_field( $settings['position']['translatex'] ) ) . ')';
            }

            if ( isset( $settings['position']['translatey'] ) && strlen( $settings['position']['translatey'] ) ) {
                echo ' translateY(' . esc_html( sanitize_text_field( $settings['position']['translatey'] ) ) . ')';
            }
            echo ';';
        }
    }
    ...
    if ( ! empty( $settings['transform'] ) ) {
        ...
        if ( $transform_css ) {
            echo 'transform:' . esc_html( $transform_css ) . ';';
        }
    ...
    if ( ! empty( $settings['boxshadow'] ) && ( ! empty( $settings['boxshadow']['type'] ) || ! empty( $settings['boxshadow']['color'] ) ) ) {
        ...
        if ( ! empty( $settings['boxshadow']['type'] ) && 'inset' != $settings['boxshadow']['type'] ) {
            echo esc_html( sanitize_text_field( $settings['boxshadow']['type'] ) );
        } else {
            ...
            if ( ! empty( $settings['boxshadow']['x'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['boxshadow']['x'] ) );
            } else {
                echo ' 0';
            }

            if ( ! empty( $settings['boxshadow']['y'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['boxshadow']['y'] ) );
            } else {
                echo ' 0';
            }

            if ( ! empty( $settings['boxshadow']['blur'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['boxshadow']['blur'] ) );
            }

            if ( ! empty( $settings['boxshadow']['spread'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['boxshadow']['spread'] ) );
            }

            if ( ! empty( $settings['boxshadow']['color'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['boxshadow']['color'] ) );
            }
        }
        echo ';';
    }
...
if ( ! empty( $settings['hover'] ) ) {
    echo 'html ' . esc_html( sanitize_text_field( $settings['selector'] ) ) . ':hover{';

    if ( ! empty( $settings['hover']['bg'] ) ) {
        echo 'background-color:' . esc_html( sanitize_text_field( $settings['hover']['bg'] ) ) . ';';
    }

    if ( ! empty( $settings['hover']['color'] ) ) {
        echo 'color:' . esc_html( sanitize_text_field( $settings['hover']['color'] ) ) . ';';
    }

    if ( ! empty( $settings['hover']['border_style'] ) ) {
        echo 'border-style:' . esc_html( sanitize_text_field( $settings['hover']['border_style'] ) ) . ';';
    }
    ...
    if ( isset( $settings['hover']['border_top'], $settings['hover']['border_right'], $settings['hover']['border_bottom'], $settings['hover']['border_left'] ) && strlen( $settings['hover']['border_top'] ) && strlen( $settings['hover']['border_right'] ) && strlen( $settings['hover']['border_bottom'] ) && strlen( $settings['hover']['border_left'] ) ) {
        echo 'border-width:' . esc_html( sanitize_text_field( $settings['hover']['border_top'] . ' ' . $settings['hover']['border_right'] . ' ' . $settings['hover']['border_bottom'] . ' ' . $settings['hover']['border_left'] ) ) . ';';
    } else {
        if ( isset( $settings['hover']['border_top'] ) && strlen( $settings['hover']['border_top'] ) ) {
            echo 'border-top-width:' . esc_html( sanitize_text_field( $settings['hover']['border_top'] ) ) . ';';
        }

        if ( isset( $settings['hover']['border_right'] ) && strlen( $settings['hover']['border_right'] ) ) {
            echo 'border-right-width:' . esc_html( sanitize_text_field( $settings['hover']['border_right'] ) ) . ';';
        }

        if ( isset( $settings['hover']['border_bottom'] ) && strlen( $settings['hover']['bottom'] ) ) {
            echo 'border-bottom-width:' . esc_html( sanitize_text_field( $settings['hover']['bottom'] ) ) . ';';
        }

        if ( isset( $settings['hover']['border_left'] ) && strlen( $settings['hover']['border_left'] ) ) {
            echo 'border-left-width:' . esc_html( sanitize_text_field( $settings['hover']['border_left'] ) ) . ';';
        }
    }

    if ( ! empty( $settings['hover']['border_color'] ) ) {
        echo 'border-color:' . esc_html( sanitize_text_field( $settings['hover']['border_color'] ) ) . ';';
    }

    if ( ! empty( $settings['hover']['top'] ) ) {
        echo 'top:' . esc_html( sanitize_text_field( $settings['hover']['top'] ) ) . ';';
    }

    if ( ! empty( $settings['hover']['right'] ) ) {
        echo 'right:' . esc_html( sanitize_text_field( $settings['hover']['right'] ) ) . ';';
    }

    if ( ! empty( $settings['hover']['bottom'] ) ) {
        echo 'bottom:' . esc_html( sanitize_text_field( $settings['hover']['bottom'] ) ) . ';';
    }

    if ( ! empty( $settings['hover']['left'] ) ) {
        echo 'left:' . esc_html( sanitize_text_field( $settings['hover']['left'] ) ) . ';';
    }
    ...
    if ( ( isset( $settings['hover']['translatex'] ) && strlen( $settings['hover']['translatex'] ) ) || ( isset( $settings['hover']['translatey'] ) && strlen( $settings['hover']['translatey'] ) ) ) {
        ...
        if ( isset( $settings['hover']['translatex'] ) && strlen( $settings['hover']['translatex'] ) ) {
            echo ' translateX(' . esc_html( $settings['hover']['translatex'] ) . ')';
        }

        if ( isset( $settings['hover']['translatey'] ) && strlen( $settings['hover']['translatey'] ) ) {
            echo ' translateY(' . esc_html( $settings['hover']['translatey'] ) . ')';
        }
        echo ';';
    }
    ...
    if ( ! empty( $settings['hover']['boxshadow'] ) && ( ! empty( $settings['hover']['boxshadow']['type'] ) || ! empty( $settings['hover']['boxshadow']['color'] ) ) ) {
        ...
        if ( ! empty( $settings['hover']['boxshadow']['type'] ) && 'inset' != $settings['hover']['boxshadow']['type'] ) {
            echo esc_html( sanitize_text_field( $settings['hover']['boxshadow']['type'] ) );
        } else {
            ...
            if ( ! empty( $settings['hover']['boxshadow']['x'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['hover']['boxshadow']['x'] ) );
            } else {
                echo ' 0';
            }

            if ( ! empty( $settings['hover']['boxshadow']['y'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['hover']['boxshadow']['y'] ) );
            } else {
                echo ' 0';
            }

            if ( ! empty( $settings['hover']['boxshadow']['blur'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['hover']['boxshadow']['blur'] ) );
            }

            if ( ! empty( $settings['hover']['boxshadow']['spread'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['hover']['boxshadow']['spread'] ) );
            }

            if ( ! empty( $settings['hover']['boxshadow']['color'] ) ) {
                echo ' ' . esc_html( sanitize_text_field( $settings['hover']['boxshadow']['color'] ) );
            }
        }
        echo ';';
    }
    ...
    if ( ! empty( $settings['hover']['color'] ) ) {
        echo 'html ' . esc_html( sanitize_text_field( $settings['selector'] ) ) . ':focus{';

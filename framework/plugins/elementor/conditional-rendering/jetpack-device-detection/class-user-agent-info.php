...
class User_Agent_Info {
    ...
    public function __construct( $ua = '' ) {
        if ( $ua ) {
            ...
            if ( ! empty( $_SERVER['HTTP_USER_AGENT'] ) ) {
                $this->useragent = strtolower( sanitize_text_field( $_SERVER['HTTP_USER_AGENT'] ) );
            }
        }
    }
    ...
    public function get_mobile_user_agent_name() {
        if ( $this->is_chrome_for_iOS() ) { // Keep this check before the safari rule.
            ...
            $agent       = strtolower( sanitize_text_field( $_SERVER['HTTP_USER_AGENT'] ) );
    ...
    public static function is_TouchPad() {
        ...
        $http_user_agent = strtolower( sanitize_text_field( $_SERVER['HTTP_USER_AGENT'] ) );
     ...
     *
     * @return bool true if the browser is Android and not 'mobile' otherwise false
     */
     ...
     *
     * @return bool true if the browser is Kindle Fire Native browser otherwise false
     */
     ...
     *
     * @return bool true if the browser is Kindle monochrome Native browser otherwise false
     */
    ...
    public static function is_bot() {
        ...
        if ( is_null( $is_bot ) ) {
            $is_bot = self::is_bot_user_agent( sanitize_text_field( $_SERVER['HTTP_USER_AGENT'] ) );
        }

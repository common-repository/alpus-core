...
if ( ! function_exists( 'alpus_elementor_banner_controls' ) ) {
    function alpus_elementor_banner_controls( $self, $mode = '' ) {
        ...
        /* ----- Hotspot ----- */
        alpus_elementor_hotspot_layout_controls( $repeater, 'hotspot_', 'banner_item_type', 'hotspot', true );
        /* ----- Hotspot ----- */
        ...
        alpus_elementor_hotspot_style_controls( $repeater, 'hotspot_', 'banner_item_type', 'hotspot', true );
        /* Hotspot Style Controls */
        ...
        alpus_elementor_addon_controls( $repeater, 'banner' );
...
if ( ! function_exists( 'alpus_elementor_banner_style_controls' ) ) {
    function alpus_elementor_banner_style_controls( $self, $condition_value = '', $widget = true ) {
        ...
        $self->add_control(
            ...
            array(
                'type'        => Controls_Manager::SELECT,
                'label'       => esc_html__( 'Background Effect', 'alpus-core' ),
                'options'     => array(
                    ''                   => esc_html__( 'No', 'alpus-core' ),
        ...
        $self->add_control(
            ...
            array(
                'label'       => esc_html__( 'Background Effect Duration (s)', 'alpus-core' ),
                'description' => esc_html__( 'Set banner background effect duration time.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => array(
                    's',
                ),
        ...
        $self->start_controls_section(
            'parallax_options',
            $widget ? array(
                'label'     => esc_html__( 'Parallax', 'alpus-core' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    'parallax' => 'yes',
                ),
            ) : array(
                'label'     => esc_html__( 'Banner', 'alpus-core' ) . ' ' . alpus_elementor_panel_heading( esc_html__( 'Parallax', 'alpus-core' ) ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => array(
                    $condition_value       => 'banner',
                    'parallax'             => 'yes',
        ...
        $self->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Choose moving direction of background when scroll down.', 'alpus-core' ),
                'type'        => Controls_Manager::CHOOSE,
                'options'     => array(
                    'up'    => array(
        ...
        $self->add_control(
            ...
            array(
                'type'        => Controls_Manager::SLIDER,
                'label'       => esc_html__( 'Parallax Speed', 'alpus-core' ),
                'description' => esc_html__( 'Change speed of banner parallax effect.', 'alpus-core' ),
                'condition'   => array(
                    'parallax' => 'yes',
                ),
                'default'     => array(

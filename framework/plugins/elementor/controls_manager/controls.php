 ...
 * @since 1.0
 */
if ( class_exists( 'Elementor\Controls_Manager' ) && ! class_exists( 'Elementor\Alpus_Controls_Manager' ) ) {
    abstract class Alpus_Controls_Manager extends Controls_Manager {

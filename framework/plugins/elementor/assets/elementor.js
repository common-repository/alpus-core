...
( function ( $ ) {
    ...
    themeAdmin.themeElementorPreview.init = function () {
        ...
        elementorFrontend.hooks.addAction( 'refresh_page_css', function ( css ) {
            var $obj = $( 'style#alpus_elementor_custom_css' );
            if ( !$obj.length ) {
                $obj = $( '<style id="alpus_elementor_custom_css"></style>' ).appendTo( 'head' );
            }
        ...
        function make_qa_item( $qa_node, qa_item, widgetRect, nodeRect, nonPos = false ) {
            var _temp = $( '<button aria-label="' + alpus_vars.texts.quick_access + '" title="' + alpus_vars.texts.quick_access + '" class="' + ( nonPos ? 'non-pos ' : '' ) + 'alpus-qa-item"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13.89 3.39l2.71 2.72c.46.46.42 1.24.03 1.64l-8.01 8.02-5.56 1.16 1.16-5.58s7.6-7.63 7.99-8.03c.39-.39 1.22-.39 1.68.07zm-2.73 2.79l-5.59 5.61 1.11 1.11 5.54-5.65zm-2.97 8.23l5.58-5.6-1.07-1.08-5.59 5.6z"></path></svg><div class="region"></div></button>' );
        ...
        ( function quick_access() {
            ...
            $( document.body ).on( 'mouseenter', '.elementor-element-editable.elementor-element', function () {
                ...
                if ( elementType == 'widget' ) {
                    ...
                    if ( widgetType ) {
                        widgetType = widgetType.slice( 0, -8 ); // because of .default: alpus_price_boxes.default
                ...
                if ( themeAdmin.quickAccessCache[ widgetKey ] ) {
                    $this.append( '<div class="alpus-quick-access"></div>' );
                    var $qa_node = $this.find( '.alpus-quick-access' ), widgetRect = this.getBoundingClientRect();
                    var nonPosElements = [];
                    ...
                    if ( widgetKey == alpus_vars.theme + '_widget_menu' ) {
                        if ( nonPosElements.length ) {
                            $this.on( 'mouseenter', '.menu>li.menu-item-has-children', function ( e ) {
                                ...
                                var $focusEl = $( this );
                                if ( $related.closest( '.alpus-qa-item.non-pos' ).length ) {
                                    return;
                                }
                                ...
                                var $nonPosNode = $this.find( '.alpus-qa-item.non-pos' );
                ...
                var $quickAccess = $( this ).find( '.alpus-quick-access' );
        ...
        if ( typeof elementorFrontend.elementsHandler.elementsHandlers.section[ 4 ] == 'function' && elementorFrontend.elementsHandler.elementsHandlers.section[ 4 ].prototype.buildSVG ) {
            ...
            elementorFrontend.elementsHandler.elementsHandlers.section[ 4 ].prototype.buildSVG = function buildSVG( side ) {
                ...
                var svgURL;
                if ( shapeType.startsWith( 'alpus-' ) ) {
                    svgURL = alpus_elementor.core_framework_url + '/../assets/images/builders/elementor/shapes/' + fileName.replace( 'alpus-', '' ) + '.svg';
                } else {
    ...
    themeAdmin.themeElementorPreview.onComplete = function () {
        ...
        // Edit menu easily 
        setTimeout( function () {
            $( '.alpus-block.elementor.elementor-edit-area-active' ).closest( '.dropdown-box' ).css( { "visibility": "visible", "opacity": "1", "top": "100%", "transform": "translate3d(0, 0, 0)" } );
            $( '.alpus-block.elementor.elementor-edit-area-active' ).parents( '.menu-item' ).addClass( 'show' );
        }, 2000 );

        $( '.alpus-block[data-el-class]' ).each( function () {
    ...
    themeAdmin.themeElementorPreview.initWidgets = function () {
        var alpus_widgets = [
            alpus_vars.theme + '_widget_products.default',
            alpus_vars.theme + '_widget_brands.default',
            alpus_vars.theme + '_widget_categories.default',
            alpus_vars.theme + '_widget_posts.default',
            alpus_vars.theme + '_widget_imagegallery.default',
            alpus_vars.theme + '_widget_single_product.default',
            alpus_vars.theme + '_widget_testimonial_group.default',
            alpus_vars.theme + '_widget_vendors.default',
            alpus_vars.theme + '_widget_posts_grid.default',
            alpus_vars.theme + '_widget_product_linked_products.default',
            alpus_vars.theme + '_widget_archive_posts_grid.default'
        ];

        // Widgets for posts
        alpus_widgets.forEach( function ( widget_name ) {
        ...
        [ 'posts', 'products', 'posts_grid', 'archive_posts_grid' ].forEach( function ( key ) {
            elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_' + key + '.default', function ( $obj ) {
                $( window ).trigger( 'alpus_loadmore' );
            } );
        } )

        // Widget for Image gallery
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_imagegallery.default', function ( $obj ) {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_countdown.default', function ( $obj ) {
            if ( typeof theme.countdown == 'function' ) {
                theme.countdown( $obj.find( '.countdown' ) );
            }
        } );
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_floating.default', function ( $obj ) {
        ...
        removeFigureMarginWidgets.forEach( function ( widget_name ) {
            elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_' + widget_name + '.default', function ( $obj ) {
        ...
        bannerWidgets.forEach( function ( widget_name ) {
            elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_' + widget_name + '.default', function ( $obj ) {
                ...
                if ( $obj.find( '.banner-stretch' ).length ) {
                    $obj.addClass( 'elementor-widget-alpus_banner_stretch' );
                } else {
                    $obj.removeClass( 'elementor-widget-alpus_banner_stretch' );
                }
        ...
        // Menu Widget
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_menu.default', function ( $obj ) {
            theme.lazyloadMenu();
            theme.menu.initMenu( '.elementor-element-' + $obj.attr( 'data-id' ) );
        } );
        // Widget for search
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_search.default', function ( $obj ) {
            if ( $obj.find( '.hs-toggle.hs-overlap' ).length ) {
                $obj.addClass( 'elementor-widget_alpus_search_overlap' );
            } else {
                $obj.removeClass( 'elementor-widget_alpus_search_overlap' );
            }
        } );

        // Widget / Animated Text
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_animated_text.default', function ( $obj ) {
            theme.animatedText( $( '.animating-text', $obj ) );
        } );

        // Widget / Image Compare
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_image_compare.default', function ( $obj ) {
            theme.imageCompare( $( '.icomp-container', $obj ) );
        } );

        // Widget / Progressbar
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_progressbars.default', function ( $obj ) {
            theme.initProgressbar( $obj.find( '.progress-wrapper' ), true );
        } );

        // Widget / Counter
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_counters.default', function ( $obj ) {
            theme.countTo( $obj.find( '.count-to' ), true );
        } );

        // Widget / Timeline
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_timeline.default', function ( $obj ) {
            theme.initTimeline( $obj.find( '.timeline-vertical' ), true );
        } );
        // Widget / Timeline - Horizontal
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_timeline_horizontal.default', function ( $obj ) {
            theme.initTimelineHorizontal( $obj.find( '.timeline-horizontal' ), true );
        } );

        // Widget / BarChart
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_bar_chart.default', function ( $obj ) {
            theme.initBarChart( $( '.bar-chart-container', $obj ) );
        } );

        // Widget / LineChart
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_line_chart.default', function ( $obj ) {
            theme.initLineChart( $( '.line-chart-container', $obj ) );
        } );

        // Widget / Pie-Doughnut Chart
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_pie_doughnut_chart.default', function ( $obj ) {
            theme.initPieDoughnutChart( $( '.pie-doughnut-chart-container', $obj ) );
        } );

        // Widget / RadarChart
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_radar_chart.default', function ( $obj ) {
            theme.initRadarChart( $( '.radar-chart-container', $obj ) );
        } );

        // Widget / RadarChart
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_polar_chart.default', function ( $obj ) {
            theme.initPolarChart( $( '.polar-chart-container', $obj ) );
        } );

        // Widget / 360 degree
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_360_degree.default', function ( $obj ) {
            theme.threeSixty( '.alpus-360-gallery-wrapper', $obj );    // 360 degree
        } );

        // Widget / Scroll Progress
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_scroll_progress.default', function ( $obj ) {
            theme.scrollProgress( $( $obj ).find( '.scroll-progress' ) );    // Scroll Progress
        } );

        // Widget / Circle Progress Bar
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_circle_progressbar.default', function ( $obj ) {
            theme.chartCircular( $( $obj ).find( '.circular-bar-chart' ) );    // Circle Progress Bar
        } );

        // Widget / Sticky Navigation
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_widget_sticky_nav.default', function ( $obj ) {
    ...
    themeAdmin.themeElementorPreview.initWooWidgets = function () {
        var alpus_widgets = [
            alpus_vars.theme + '_sproduct_image.default',
        ];
        ...
        // Cart form sticky
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_sproduct_cart_form.default', function ( $obj ) {
            ...
            if ( $obj.find( '.product-sticky-content' ).length ) {
                ...
                $( '.elementor-section-wrap' ).data( 'alpus_product_single' ).stickyCartForm( $( '.elementor-section-wrap .product-sticky-content' ) );
            }
        } );

        // Sticky thumbs type
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_sproduct_image.default', function ( $obj ) {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_sproduct_flash_sale.default', function ( $obj ) {
            if ( typeof theme.countdown == 'function' ) {
                theme.countdown( $obj.find( '.countdown' ) );
            }
        } );
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_sproduct_data_tab.default', function ( $obj ) {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_checkout_widget_billing.default', function ( $obj ) {
        ...
        elementorFrontend.hooks.addAction( 'frontend/element_ready/' + alpus_vars.theme + '_checkout_widget_shipping.default', function ( $obj ) {
    ...
    themeAdmin.themeElementorPreview.initSection = function ( $obj ) {
        ...
        if ( $row.hasClass( 'parallax' ) && $.fn.themeParallax ) {
    ...
    themeAdmin.themeElementorPreview.initColumn = function ( $obj ) {
        ...
        if ( $column.data( 'sticky-column' ) ) {
            $column.closest( '.elementor-column' ).addClass( 'alpus-sticky-column' );
        } else {
            $column.closest( '.elementor-column' ).removeClass( 'alpus-sticky-column' );
        }
        ...
        if ( $row.hasClass( 'grid' ) || $row.children( '.elementor-row.grid' ).length ) { // Refresh isotope
            ...
            if ( !$row.data( 'creative-preset' ) ) {
                $.ajax( {
                    url: alpus_elementor.ajax_url,
                    data: {
                        action: 'alpus_load_creative_layout',
                        nonce: alpus_elementor.wpnonce,
        ...
        if ( $row.hasClass( 'slider-wrapper' ) ) { // Slider
            ...
            var title = $column.data( 'tab-title' ) || alpus_elementor.text_untitled;
            ...
            html += title;
            if ( !title && !icon ) {
                html += wp.i18n.__( 'Tab Title', 'alpus-core' );
            }
            ...
            var title = $column.data( 'accordion-title' ) || alpus_elementor.text_untitled;
        ...
        if ( widget_settings.ribbon && widget_settings.ribbon.enabled ) {
            ...
            if ( !$ribbon_after.siblings( '.ribbon' ).length ) {
                var $ribbon =
                    ...
                    '<span class="ribbon-text">' + ( widget_settings.ribbon.text ? widget_settings.ribbon.text : alpus_vars.texts.ribbon ) + '</span>' +
                    '</div>';
            ...
            if ( floating_settings.type ) {
                if ( 0 == floating_settings.type.indexOf( 'mouse_tracking' ) ) {
                    ...
                    if ( $.fn.parallax ) {
                        ...
                        if ( alpus_elementor.core_framework_url ) {
                            $( document.createElement( 'script' ) ).attr( 'id', 'jquery-floating' ).appendTo( 'body' ).attr( 'src', alpus_elementor.core_framework_url + '/assets/js/jquery.floating.min.js' ).on( 'load', function () {
                                theme.initFloatingElements( $obj );
                            } );
                        }
                    }
                    ...
                    if ( typeof skrollr != 'object' ) {
                        if ( alpus_elementor.core_framework_url ) {
                            $( document.createElement( 'script' ) ).attr( 'id', 'jquery-skrollr' ).appendTo( 'body' ).attr( 'src', alpus_elementor.core_framework_url + '/assets/js/skrollr.min.js' ).on( 'load', function () {
    ...
    themeAdmin.themeElementorPreview.widgetEditorSettings = function ( widgetId ) {
        ...
        var floating = {
            type: widgetData[ 'alpus_floating' ],
            m_track_dir: widgetData[ 'alpus_m_track_dir' ],
            m_track_speed: 'object' == typeof widgetData[ 'alpus_m_track_speed' ] && widgetData[ 'alpus_m_track_speed' ][ 'size' ] ? widgetData[ 'alpus_m_track_speed' ][ 'size' ] : 0.5,
            scroll_size: 'object' == typeof widgetData[ 'alpus_scroll_size' ] && widgetData[ 'alpus_scroll_size' ][ 'size' ] ? widgetData[ 'alpus_scroll_size' ][ 'size' ] : 50,
            scroll_stop: 'undefined' == typeof widgetData[ 'alpus_scroll_stop' ] ? 'center' : widgetData[ 'alpus_scroll_stop' ]
        };
        var duplex = {};
        if ( 'true' == widgetData[ 'alpus_widget_duplex' ] ) {
            duplex.enabled = true;
            duplex.origin = widgetData[ 'alpus_widget_duplex_origin' ];
            if ( 'text' == widgetData[ 'alpus_widget_duplex_type' ] ) {
                duplex.type = 'text';
                duplex.text = widgetData[ 'alpus_widget_duplex_text' ];
            } else {
                duplex.type = 'image';
                duplex.image = {
                    url: widgetData[ 'alpus_widget_duplex_image' ][ 'url' ]
                };
            }
        }

        var ribbon = {};
        if ( 'true' == widgetData[ 'alpus_widget_ribbon' ] ) {
            ribbon.enabled = true;
            ribbon.type = widgetData[ 'alpus_widget_ribbon_type' ];
            ribbon.text = widgetData[ 'alpus_widget_ribbon_text' ];
            ribbon.position = widgetData[ 'alpus_widget_ribbon_position' ];
        }
    ...
    themeAdmin.themeElementorPreview.initGlobal = function () {
        elementorFrontend.hooks.addAction( 'alpus_elementor_element_after_add', function ( e ) {
        ...
        elementorFrontend.hooks.addAction( 'alpus_elementor_element_before_delete', function ( e ) {
            var $obj = $( '[data-id="' + e.id + '"]' ),
                $row = $obj.closest( '.elementor-row, .elementor-container' ),
    ...
    $( window ).on( 'load', function () {
        if ( typeof elementorFrontend != 'undefined' && typeof theme != 'undefined' ) {
            ...
            if ( window.top.alpus_core_vars && window.top.alpus_core_vars.template_type && ( window.top.alpus_core_vars.template_type == 'header' || window.top.alpus_core_vars.template_type == 'footer' ) ) {
                window.top.elementor.presetsFactory.getPresetSVG = function getPresetSVG( preset, svgWidth, svgHeight, separatorWidth ) {
                    ...
                    if ( _.isEqual( preset, [ 'flex-1', 'flex-auto' ] ) ) {
                        ...
                        svg.innerHTML = '<rect fill="#D5DADF" width="73.8" height="44.2"></rect> <rect x="75.5" fill="#D5DADF" width="12.8" height="44.2"></rect> <text transform="matrix(1 0 0 1 8.5 25.9167)" fill="#A7A9AC" font-family="Segoe Script" font-size="12">For ' + window.top.alpus_core_vars.template_type + '</text>';
                        return svg;
                    }
                        ...
                        svg.setAttribute( 'viewBox', '0 0 88.3 44.2' );
                        svg.setAttributeNS( protocol + '://www.w3.org/2000/xmlns/', 'xmlns:xlink', protocol + '://www.w3.org/1999/xlink' );
                        svg.innerHTML = '<rect fill="#D5DADF" width="35" height="44.2"></rect><rect x="53.4" fill="#D5DADF" width="35" height="44.2" ></rect><rect x="36.9" fill="#D5DADF" width="14.5" height="44.2"></rect><text transform="matrix(1 0 0 1 8.5 25.9167)" fill="#A7A9AC" font-family="Segoe Script" font-size="12">For ' + window.top.alpus_core_vars.template_type + '</text>';
                        return svg;
                    }
            ...
            if ( $( 'body' ).hasClass( 'alpus_popup_template' ) ) {
                var $edit_area = $( 'main [data-elementor-id]' ),
                    id = $edit_area.data( 'elementor-id' );
                $edit_area.parent().prepend( '<div class="mfp-bg mfp-fade mfp-alpus-' + id + ' mfp-ready"></div>' );
                $edit_area.wrap( '<div class="mfp-wrap mfp-close-btn-in mfp-auto-cursor mfp-fade mfp-alpus mfp-alpus-' + id + ' mfp-ready" tabindex="-1" style="overflow: hidden auto;"><div class="mfp-container mfp-inline-holder"><div class="mfp-content"><div id="alpus-popup-' + id + '" class="popup mfp-fade"><div class="alpus-popup-content"></div></div></div></div></div>' )
            }

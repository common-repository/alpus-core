...
if ( ! class_exists( 'Alpus_Control_Ajaxselect2' ) ) {
    class Alpus_Control_Ajaxselect2 extends Base_Data_Control {
        ...
        public function enqueue() {
            wp_enqueue_script( 'alpus-ajax-select2-control', alpus_core_framework_uri( '/plugins/elementor/controls/ajaxselect2-editor' . ALPUS_JS_SUFFIX ) );
        }

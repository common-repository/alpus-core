...
class Alpus_Core_Custom_Field_Tag extends Elementor\Core\DynamicTags\Tag {

    public function get_name() {
        return 'alpus-custom-field';
    }

    public function get_title() {
        return esc_html__( 'Custom Field', 'alpus-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            array(
                'label'     => esc_html__( 'Taxonomy Field', 'alpus-core' ),
                'type'      => Elementor\Controls_Manager::SELECT,
                'default'   => '',
        ...
        //Add acf field
        do_action( 'alpus_dynamic_extra_fields', $this );
    ...
    public function get_objects() {
        $objects = array(
            'general'   => esc_html__( 'Posts/Users', 'alpus-core' ),
            'taxonomy'  => esc_html__( 'Taxonomies', 'alpus-core' ),
            'meta_data' => esc_html__( 'Meta Data', 'alpus-core' ),
        );
    ...
    public function get_object_fields() {
        $fields = array(
            ...
            array(
                'label'   => esc_html__( 'User', 'alpus-core' ),
                'options' => array(
                    'ID'              => esc_html__( 'ID', 'alpus-core' ),
                    'user_login'      => esc_html__( 'Login', 'alpus-core' ),
                    'user_nicename'   => esc_html__( 'Nickname', 'alpus-core' ),
                    'user_email'      => esc_html__( 'E-mail', 'alpus-core' ),
                    'user_url'        => esc_html__( 'URL', 'alpus-core' ),
                    'user_registered' => esc_html__( 'Registration Date', 'alpus-core' ),
                    'display_name'    => esc_html__( 'Display Name', 'alpus-core' ),
                ),
            ),
        );
    ...
    public function get_taxonomy_fields() {
        ...
        $result = array(
            array(
                'label'   => esc_html__( 'Taxonomies', 'alpus-core' ),
    ...
    public function render() {
        ...
        switch ( $atts['dynamic_field_source'] ) {
            case 'general':
                ...
                } elseif ( 'alpus_post_likes' == $property ) {

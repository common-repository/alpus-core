...
class Alpus_Core_Custom_Field_Taxonomies_Tag extends Elementor\Core\DynamicTags\Tag {

    public function get_name() {
        return 'alpus-custom-field-taxonomies';
    }

    public function get_title() {
        return esc_html__( 'Taxonomies', 'alpus-core' );
    }

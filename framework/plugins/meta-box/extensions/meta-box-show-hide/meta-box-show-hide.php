    ...
    class MB_Show_Hide {
        ...
        public function js_data( RW_Meta_Box $obj ) {
            ...
            if ( $data ) {
                ...
                echo '<script type="text/html" class="mb-show-hide"' . alpus_escaped( $data ) . '></script>';
            }
        }
        ...
        public function get_post_id() {
            ...
            } elseif ( isset( $_POST['post_ID'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                $post_id = intval( $_POST['post_ID'] ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            }

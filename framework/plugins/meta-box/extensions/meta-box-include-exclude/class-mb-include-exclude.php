 ...
 *
 * @see       https://metabox.io/plugins/meta-box-include-exclude/
 */
...
class MB_Include_Exclude {
    ...
    protected static function get_current_post_id() {
        ...
        $post_id = isset( $_GET['post'] ) ? (int) $_GET['post'] : ( isset( $_POST['post_ID'] ) ? (int) $_POST['post_ID'] : false ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended

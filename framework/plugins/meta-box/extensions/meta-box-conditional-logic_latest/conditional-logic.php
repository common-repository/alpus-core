...
class MB_Conditional_Logic {
    ...
    public function insert_meta_box_conditions( $obj ) {
        echo alpus_escaped( $this->get_conditions_html( $obj->meta_box ) );
    }
    ...
    private function slug_to_id( $slugs ) {
        ...
        return array_map( 'intval', $wpdb->get_col( $prepared ) ); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
    }
}

<?php
/**
 * Alpus Header Elementor Language Switcher
 */
defined( 'ABSPATH' ) || die;
...
class Alpus_Header_Language_Switcher_Elementor_Widget extends \Elementor\Widget_Base {

    public function get_name() {
        return ALPUS_NAME . '_header_language_switcher';
    }

    public function get_title() {
        return esc_html__( 'Language Switcher', 'alpus-core' );
    }

    public function get_icon() {
        return 'fas fa-language alpus-elementor-widget-icon';
    }
    ...
    public function get_keywords() {
        return array( 'header', 'switcher', 'language', 'alpus', 'multi', 'translate' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_item_style',
            array(
                'label' => esc_html__( 'Language item', 'alpus-core' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Controls the padding value of sub item.', 'alpus-core' ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Controls the position of dropdown box.', 'alpus-core' ),
            )
        );
    ...
    protected function render() {
        require alpus_core_framework_path( ALPUS_BUILDERS . '/header/widgets/language-switcher/render-language-switcher-elementor.php' );
    }
}

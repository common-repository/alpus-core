...
if ( has_nav_menu( 'lang-switcher' ) ) {
    ...
    if ( ! empty( $languages ) && 1 < count( $languages ) ) {
        ...
        foreach ( $languages as $l ) {
            ...
            if ( $l['active'] ) {
                 ...
                 * @since 1.0
                 */
                $active_lang .= icl_disp_language( $l['native_name'], $l['translated_name'], apply_filters( 'alpus_icl_show_native_name', true, $l ) );
            } else {
                /*
                 * Filters the native name in language switcher.
                 *
                 * @since 1.0
                 */
                $other_langs .= icl_disp_language( $l['native_name'], $l['translated_name'], apply_filters( 'alpus_icl_show_native_name', true, $l ) );
            }
		...
		<ul class="menu switcher lang-switcher">
			<li class="menu-item-has-children">
				<a class="switcher-toggle" href="#"><?php echo alpus_strip_script_tags( $active_lang ); ?></a>
				<?php if ( $other_langs ) { ?>
				<ul>
					<?php echo alpus_strip_script_tags( $other_langs ); ?>
				</ul>
				<?php } ?>
			</li>
		</ul>
    ...
    if ( defined( 'ALPUS_VERSION' ) ) {
        wp_enqueue_style( 'alpus-flag' );
    }
    ?>
	<ul class="menu switcher lang-switcher">
		<li class="menu-item-has-children">
			<a href="#" class="switcher-toggle"><i class="flag flag-us"></i><?php esc_html_e( 'ENG', 'alpus-core' ); ?></a>
			<ul>
				<li><a href="#"><i class="flag flag-us"></i><?php esc_html_e( 'ENG', 'alpus-core' ); ?></a></li>
				<li><a href="#"><i class="flag flag-fr"></i><?php esc_html_e( 'FRA', 'alpus-core' ); ?></a></li>
			</ul>
		</li>
	</ul>
	<?php

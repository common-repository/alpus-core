...
if ( is_user_logged_in() ) {
    ...
    if ( in_array( 'login', $items ) || ( ! in_array( 'register', $items ) && in_array( 'icon', $items ) ) ) {
        $html .= '<a class="login ' . esc_attr( $form_type ) . ' ' . esc_attr( $type ) . '" href="' . esc_url( $login_link ) . '" aria-label="' . esc_attr__( 'Login', 'alpus-core' ) . '">';
    ...
    if ( in_array( 'register', $items ) ) {
        ...
        $html .= '<a class="register ' . esc_attr( $form_type ) . ' ' . esc_attr( $type ) . '" href="' . ( $register_link ? esc_url( $register_link ) : esc_url( $login_link ) ) . '" aria-label="' . esc_attr__( 'Register', 'alpus-core' ) . '">';

...
extract( // @codingStandardsIgnoreLine
    shortcode_atts(
        array(
            'title'     => __( 'Input Title Here', 'alpus-core' ),
            'subtitle'  => __( 'Input Subtitle Here', 'alpus-core' ),
...
$title_html    = $title ? '<h3 class="title">' . alpus_strip_script_tags( $title ) . '</h3>' : '';
$subtitle_html = $subtitle ? '<h4 class="subtitle">' . esc_html( $subtitle ) . '</h4>' : '';
$content_html  = $content ? '<div class="content">' . alpus_strip_script_tags( $content ) . '</div>' : '';

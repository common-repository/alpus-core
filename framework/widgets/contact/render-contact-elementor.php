...
if ( $self && alpus_is_elementor_preview() ) {
...
?>
<div class="contact">
	<a class="d-flex" href="<?php echo esc_url( $tel_num_attrs['href'] ); ?>" aria-label="<?php esc_attr_e( 'Contact', 'alpus-core' ); ?>">
	<?php
...
echo ' <span class="contact-delimiter">' . alpus_escaped( $delimiter ) . '</span> ';

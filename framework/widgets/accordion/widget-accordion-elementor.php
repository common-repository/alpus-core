...
/*
 * Alpus Accordion Widget Addon
 *
 * Alpus Accordion Widget Addon using Elementor Section/Column Element
 *
 * @author     D-THEMES
...
if ( ! class_exists( 'Alpus_Accordion_Elementor_Widget_Addon' ) ) {
    class Alpus_Accordion_Elementor_Widget_Addon extends Alpus_Base {
        ...
        public function __construct() {
            ...
            add_filter( 'alpus_elementor_column_addon_render_attributes', array( $this, 'column_addon_attributes' ), 10, 3 );
        ...
        public function enqueue_scripts() {
            if ( alpus_is_elementor_preview() ) {
                wp_enqueue_style( 'alpus-accordion', alpus_core_framework_uri( '/widgets/accordion/accordion' . ( is_rtl() ? '-rtl' : '' ) . '.min.css' ), array(), ALPUS_CORE_VERSION );
            }
        }
        ...
        public function register_section_addon( $addons ) {
            $addons['accordion'] = esc_html__( 'Accordion', 'alpus-core' );
        ...
        public function add_section_controls( $self, $condition_value ) {
            $self->add_control(
                ...
                array(
                    'raw'             => sprintf( esc_html__( 'Use %1$schild columns%2$s as %1$saccordion content%2$s by using %1$s%3$s settings%2$s.', 'alpus-core' ), '<b>', '</b>', ALPUS_DISPLAY_NAME, ),
            ...
            $self->start_controls_section(
                'section_accordion',
                array(
                    'label'     => alpus_elementor_panel_heading( esc_html__( 'Accordion', 'alpus-core' ) ),
            ...
            $self->add_control(
                'accordion_type',
                array(
                    'label'       => esc_html__( 'Accordion Type', 'alpus-core' ),
                    'description' => esc_html__( 'Choose the design style for accordion.', 'alpus-core' ),
                    'type'        => Controls_Manager::SELECT,
                    'default'     => '',
                    'width'       => 1,
                    'options'     => array(
                        ''        => esc_html__( 'Default', 'alpus-core' ),
                        'shadow'  => esc_html__( 'Shadow', 'alpus-core' ),
            ...
            $self->add_control(
                ...
                array(
                    'label'     => esc_html__( 'Card', 'alpus-core' ),
            ...
            $self->add_control(
                ...
                array(
                    'label'       => esc_html__( 'Card Space', 'alpus-core' ),
                    'description' => esc_html__( 'Set the space between each card items.', 'alpus-core' ),
                    ...
                    'selectors'   => array(
                        '.elementor-element-{{ID}} .accordion' => '--alpus-accordion-card-spacing: {{SIZE}}{{UNIT}}',
                    ),
                )
            );
            ...
            $self->add_control(
                ...
                array(
                    'label'     => esc_html__( 'Card Header', 'alpus-core' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                )
            );
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'description'      => esc_html__( 'Choose inactive(closed) toggle icon of card header.', 'alpus-core' ),
            ...
            $self->add_control(
                ...
                array(
                    'label'            => esc_html__( 'Active Toggle Icon', 'alpus-core' ),
                    'description'      => esc_html__( 'Choose active(opened) toggle icon of card header.', 'alpus-core' ),
                    'type'             => Controls_Manager::ICONS,
                    'fa4compatibility' => 'icon_active',
                    'default'          => array(
                        'value'   => ALPUS_ICON_PREFIX . '-icon-minus',
                        'library' => 'alpus-icons',
                    ),
                    'recommended'      => array(
                        'fa-solid'   => array(
            ...
            $self->add_responsive_control(
                ...
                array(
                    'type'        => Controls_Manager::SLIDER,
                    'label'       => esc_html__( 'Toggle Icon Size', 'alpus-core' ),
                    'description' => esc_html__( 'Set size of card header toggle icon.', 'alpus-core' ),
                    'size_units'  => array( 'px', 'rem', 'em' ),
                    'range'       => array(
                        'px'  => array(
                            'step' => 1,
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'description' => esc_html__( 'Set background color of card including card header and card body.', 'alpus-core' ),
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'description' => esc_html__( 'Set the border width of accordion card.', 'alpus-core' ),
                    'size_units'  => array(
                        'px',
                        '%',
                    ),
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'type'        => Controls_Manager::DIMENSIONS,
                    'description' => esc_html__( 'Set the border radius of accordion card.', 'alpus-core' ),
                    'size_units'  => array(
                        'px',
                        '%',
                    ),
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'description' => esc_html__( 'Set border color of card.', 'alpus-core' ),
                    'type'        => Controls_Manager::COLOR,
                    'selectors'   => array(
                        '.elementor-element-{{ID}} .accordion .card' => '--alpus-accordion-border-color: {{VALUE}};',
                    ),
                )
            );
            ...
            $self->add_group_control(
                ...
                array(
                    ...
                    'description' => esc_html__( 'Set box shadow of entire accordion.', 'alpus-core' ),
            ...
            $self->add_group_control(
                ...
                array(
                    ...
                    'description' => esc_html__( 'Set typography of card headers.', 'alpus-core' ),
            ...
            $self->add_responsive_control(
                ...
                array(
                    ...
                    'type'        => Controls_Manager::DIMENSIONS,
                    'description' => esc_html__( 'Set padding of card headers.', 'alpus-core' ),
                    'size_units'  => array(
                        'px',
                        '%',
                    ),
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'type'        => Controls_Manager::COLOR,
                    'description' => esc_html__( 'Controls normal color of card header.', 'alpus-core' ),
                    'selectors'   => array(
            ...
            $self->add_control(
                ...
                array(
                    'label'       => esc_html__( 'Background Color', 'alpus-core' ),
                    'type'        => Controls_Manager::COLOR,
                    'description' => esc_html__( 'Controls normal background color of card header.', 'alpus-core' ),
                    'selectors'   => array(
            ...
            $self->add_control(
                ...
                array(
                    'label'       => esc_html__( 'Color', 'alpus-core' ),
                    'type'        => Controls_Manager::COLOR,
                    'description' => esc_html__( 'Controls color of active card header', 'alpus-core' ),
                    'selectors'   => array(
            ...
            $self->add_control(
                ...
                array(
                    'label'       => esc_html__( 'Background Color', 'alpus-core' ),
                    'type'        => Controls_Manager::COLOR,
                    'description' => esc_html__( 'Controls background color of active card header.', 'alpus-core' ),
                    'selectors'   => array(
            ...
            $self->add_control(
                ...
                array(
                    'label'     => esc_html__( 'Card Body', 'alpus-core' ),
                    'type'      => Controls_Manager::HEADING,
                    'separator' => 'before',
                )
            );
            ...
            $self->add_responsive_control(
                ...
                array(
                    'label'       => esc_html__( 'Padding', 'alpus-core' ),
                    'description' => esc_html__( 'Set padding of card body content.', 'alpus-core' ),
                    'type'        => Controls_Manager::DIMENSIONS,
                    'size_units'  => array(
                        'px',
                        '%',
        ...
        public function section_addon_attributes( $options, $self, $settings ) {
            if ( 'accordion' == $settings['use_as'] ) {
                ...
                if ( ! isset( $alpus_section['section'] ) ) {
                    $alpus_section = array(
                        'section'     => 'accordion',
        ...
        public function register_column_addon( $addons ) {
            $addons['accordion_content'] = alpus_elementor_panel_heading( esc_html__( 'Accordion Content', 'alpus-core' ) );
        ...
        public function add_column_controls( $self, $condition_value ) {
            ...
            $self->start_controls_section(
                'column_acc',
                array(
                    'label'     => alpus_elementor_panel_heading( esc_html__( 'Accordion Content', 'alpus-core' ) ),
                    'tab'       => Controls_Manager::TAB_LAYOUT,
                    'condition' => array(
            ...
            $self->add_control(
                'accordion_title',
                array(
                    'label'       => esc_html__( 'Card Title', 'alpus-core' ),
                    'description' => esc_html__( 'Set header title of each card items.', 'alpus-core' ),
                    'type'        => Controls_Manager::TEXT,
                    'default'     => esc_html__( 'Accordion Title', 'alpus-core' ),
                )
            );
            ...
            $self->add_control(
                ...
                array(
                    'label'            => esc_html__( 'Prefix Icon', 'alpus-core' ),
                    'description'      => esc_html__( 'Choose different prefix icon of each card headers.', 'alpus-core' ),
                    'type'             => Controls_Manager::ICONS,
                    'fa4compatibility' => 'icon',
                    'skin'             => 'inline',
                    'label_block'      => false,
            ...
            $self->add_control(
                ...
                array(
                    'label'       => esc_html__( 'Prefix Icon Size', 'alpus-core' ),
                    'description' => esc_html__( 'Set font size of prefix icons of card headers.', 'alpus-core' ),
                    'type'        => Controls_Manager::SLIDER,
                    'size_units'  => array(
                        'px',
                        'rem',
            ...
            $self->add_control(
                ...
                array(
                    'label'       => esc_html__( 'Prefix Icon Space', 'alpus-core' ),
                    'description' => esc_html__( 'Set spacing between prefix icon and card header title.', 'alpus-core' ),
                    'type'        => Controls_Manager::SLIDER,
                    'size_units'  => array(
                        'px',
                        'rem',
        ...
        public function column_addon_render( $self, $settings, $has_background_overlay, $is_legacy_mode_active ) {
            if ( 'accordion_content' == $settings['use_as'] ) {
                ?>
			<<?php echo alpus_escaped( $self->get_html_tag() ) . ' ' . alpus_escaped( $self->get_render_attribute_string( '_wrapper' ) ); ?>>
				<?php
                global $alpus_section;
                ?>
				<h4 class="card-header">
					<a href="<?php echo esc_attr( $self->get_data( 'id' ) ); ?>" class="<?php echo 1 == $alpus_section['index'] ? esc_html__( 'collapse', 'alpus-core' ) : esc_html__( 'expand', 'alpus-core' ); ?>">
						<?php
                        if ( $settings['accordion_header_icon']['value'] ) {
                            echo alpus_escaped( $this->widget_accordion_get_label( $settings, 'accordion_header_icon' ) );
                        }
                ?>
						<span class="title"><?php echo ! $settings['accordion_title'] ? esc_html__( 'Untitled', 'alpus-core' ) : esc_html( $settings['accordion_title'] ); ?></span>
						<?php
                if ( isset( $alpus_section['active_icon'] ) && $alpus_section['active_icon']['value'] ) {
                    printf( '<span class="toggle-icon opened">%1$s</span>', $this->widget_accordion_get_label( $alpus_section, 'active_icon' ) );
                }

                if ( isset( $alpus_section['icon'] ) && $alpus_section['icon']['value'] ) {
                    printf( '<span class="toggle-icon closed">%1$s</span>', $this->widget_accordion_get_label( $alpus_section, 'icon' ) );
                }
                ?>
					</a>
				</h4>
        ...
        public function column_addon_attributes( $options, $self, $settings ) {
            if ( 'accordion_content' == $settings['use_as'] ) {
                ...
                if ( isset( $alpus_section['section'] ) ) {
                    ...
                    if ( 'accordion' == $alpus_section['section'] ) {
                        if ( 0 == $alpus_section['index'] ) {
                    ...
                    $alpus_section['index'] = ++$alpus_section['index'];
                }
            }
 ...
 * @since 1.2.0
 */
Alpus_Accordion_Elementor_Widget_Addon::get_instance();

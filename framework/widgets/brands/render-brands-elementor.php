...
if ( 'slider' == $layout_type ) { // render brands with swiper
    ...
    echo '<div ' . alpus_escaped( $wrapper_attrs ) . ' class="product-brands ' . esc_attr( $wrapper_class ) . '">';
    ...
    if ( 1 == $brand_type ) {
        ...
        ?>
				...
				<div class="brand-info">
					...
					<span class="brand-product-count">(<?php echo esc_attr( count( $list->posts ) ) . esc_html__( ' Products', 'alpus-core' ); ?> )</span>
					<?php
                    if ( 'yes' == $show_brand_rating ) {
                        ?>
					<div class="ratings-container">

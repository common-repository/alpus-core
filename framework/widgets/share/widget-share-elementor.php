 ...
 * Alpus Share Widget
 *
 * Alpus Widget to display share buttons.
 *
 * @author     D-THEMES
...
class Alpus_Share_Elementor_Widget extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return ALPUS_NAME . '_widget_share';
    }

    public function get_title() {
        return esc_html__( 'Social', 'alpus-core' );
    }
    ...
    public function get_keywords() {
        return array( 'Share', 'Social', 'link', 'alpus' );
    }

    public function get_icon() {
        return 'alpus-elementor-widget-icon alpus-widget-icon-share';
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Share Buttons', 'alpus-core' ),
            )
        );
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Select social network for each social items.', 'alpus-core' ),
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Please Leave it blank to share this page or Input URL for a custom link.', 'alpus-core' ),
                'options'     => false,
            )
        );
        ...
        $this->add_control(
            'share_buttons',
            array(
                'label'       => esc_html__( 'Share Icons', 'alpus-core' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Choose social link item type. Choose from Simple, Shadow, Stacked, Framed.', 'alpus-core' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Choose border style of social link item. Choose from Square, Rounded, Ellipse.', 'alpus-core' ),
                'type'        => Controls_Manager::SELECT,
                'options'     => array(
                    '0'    => esc_html__( 'Rectangle', 'alpus-core' ),
                    '10px' => esc_html__( 'Rounded', 'alpus-core' ),
                    '50%'  => esc_html__( 'Circle', 'alpus-core' ),
                ),
                'default'     => '50%',
                'selectors'   => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'label'       => esc_html__( 'Direction', 'alpus-core' ),
                'description' => esc_html__( 'Determine whether to arrange social link items horizontally or vertically.', 'alpus-core' ),
                'options'     => array(
                    'row'    => array(
                        'title' => esc_html__( 'Row', 'alpus-core' ),
                        'icon'  => 'eicon-arrow-right',
                    ),
                    'column' => array(
                        'title' => esc_html__( 'Column', 'alpus-core' ),
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Choose alignment of social icons. Choose from Left, Center, Right, Justified.', 'alpus-core' ),
                'type'        => Controls_Manager::CHOOSE,
                'options'     => array(
                    'flex-start'    => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'label'       => esc_html__( 'Use Custom Color', 'alpus-core' ),
                'description' => esc_html__( 'Enables you to change color scheme of social icons.', 'alpus-core' ),
            )
        );
        ...
        $this->start_controls_section(
            'section_share_style',
            array(
                'label' => esc_html__( 'Share Icons Style', 'alpus-core' ),
        ...
        $this->add_responsive_control(
            'button_size',
            array(
                'label'       => esc_html__( 'Button Size (px)', 'alpus-core' ),
                'description' => esc_html__( 'Controls entire size of social items.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'range'       => array(
                    'px' => array(
                        'step' => 1,
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Controls only icon size of social items.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'range'       => array(
                    'px' => array(
                        'step' => 1,
        ...
        $this->add_responsive_control(
            'col_space',
            array(
                'label'       => esc_html__( 'Column Gap (px)', 'alpus-core' ),
                'description' => esc_html__( 'Controls horizontal space (Left and Right) of social items.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'range'       => array(
                    'px' => array(
                        'step' => 1,
        ...
        $this->add_responsive_control(
            'row_space',
            array(
                'label'       => esc_html__( 'Row Gap (px)', 'alpus-core' ),
                'description' => esc_html__( 'Controls vertical space (Top and Bottom) of social items.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'range'       => array(
                    'px' => array(
                        'step' => 1,
    ...
    protected function render() {
        ...
        $atts['self'] = $this;
        require alpus_core_framework_path( ALPUS_CORE_FRAMEWORK_PATH . '/widgets/share/render-share-elementor.php' );
    }
}

    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Select the decoration type among Simple, Cross and Underline options. The Default type is the Simple type.', 'alpus-core' ),
                'default'     => '',
                'options'     => array(
                    ''          => esc_html__( 'Simple', 'alpus-core' ),
                    'cross'     => esc_html__( 'Cross', 'alpus-core' ),
        ...
        $this->add_control(
            'show_link',
            array(
                'label'       => esc_html__( 'Show Link?', 'alpus-core' ),
                'description' => esc_html__( 'Toggle for making your heading has link or not.', 'alpus-core' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Type a certain URL to link through other pages.', 'alpus-core' ),
        ...
        $this->add_control(
            'link_label',
            array(
                'label'       => esc_html__( 'Link Label', 'alpus-core' ),
                'description' => esc_html__( 'Type a certain label of your heading link.', 'alpus-core' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Upload a certain icon of your heading link.', 'alpus-core' ),
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Select a certain position of your icon.', 'alpus-core' ),
                'type'        => Controls_Manager::SELECT,
                'default'     => 'after',
                'options'     => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Type a certain number for the space between label and icon.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'range'       => array(
                    'px' => array(
                        'step' => 1,
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Type a certain number for your icon size.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'range'       => array(
                    'px' => array(
                        'step' => 1,
                ...
                'selectors'   => array(
                    '.elementor-element-{{ID}}'         => '--alpus-heading-icon-size: {{SIZE}}px;',
        ...
        $this->add_control(
            'link_align',
            array(
                'label'       => esc_html__( 'Link Align', 'alpus-core' ),
                'description' => esc_html__( 'Choose a certain alignment of your heading link.', 'alpus-core' ),
                'type'        => Controls_Manager::CHOOSE,
                'options'     => array(
                    'link-left'  => array(
                        'title' => esc_html__( 'Left', 'alpus-core' ),
        ...
        $this->add_control(
            'show_divider',
            array(
                'label'       => esc_html__( 'Show Divider?', 'alpus-core' ),
                'description' => esc_html__( 'Toggle for making your heading has a divider or not. It is only available in left alignment.', 'alpus-core' ),
                'type'        => Controls_Manager::SWITCHER,
                'condition'   => array(
        ...
        $this->add_control(
            'link_gap',
            array(
                'label'       => esc_html__( 'Link Space', 'alpus-core' ),
                'description' => esc_html__( 'Type a certain number for the space between heading and link.', 'alpus-core' ),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => array(
                    'px',
                    '%',
        ...
        $this->add_responsive_control(
            'title_spacing',
            array(
                'label'       => esc_html__( 'Title Padding', 'alpus-core' ),
                'description' => esc_html__( 'Controls title padding.', 'alpus-core' ),
        ...
        $this->add_responsive_control(
            'link_spacing',
            array(
                'label'       => esc_html__( 'Link Spacing', 'alpus-core' ),
                'description' => esc_html__( 'Controls the spacing of link button.', 'alpus-core' ),
                'type'        => Controls_Manager::DIMENSIONS,
                'size_units'  => array(
                    'px',
                    'em',
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Controls the link color.', 'alpus-core' ),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => array(
        ...
        $this->add_control(
            ...
            array(
                ...
                'description' => esc_html__( 'Controls the link hover color.', 'alpus-core' ),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => array(

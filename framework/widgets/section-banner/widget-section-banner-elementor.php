...
if ( ! class_exists( 'Alpus_Section_Banner_Elementor_Widget_Addon' ) ) {
    class Alpus_Section_Banner_Elementor_Widget_Addon extends Alpus_Base {
        ...
        public function register_section_addon( $addons ) {
            $addons['banner'] = esc_html__( 'Banner', 'alpus-core' );
        ...
        public function add_section_controls( $self, $condition_value ) {
            ...
            $self->add_control(
                ...
                array(
                    'raw'             => sprintf( esc_html__( 'Use %1$schild columns%2$s as %1$sbanner layer%2$s by using %1$s%3$s settings%2$s.', 'alpus-core' ), '<b>', '</b>', ALPUS_DISPLAY_NAME, ),
            ...
            $self->start_controls_section(
                'section_banner',
                array(
                    'label'     => alpus_elementor_panel_heading( esc_html__( 'Banner', 'alpus-core' ) ),
            ...
            alpus_elementor_banner_layout_controls( $self, false, $condition_value );

            $self->add_control(
                'video_banner_switch',
                array(
                    'label'       => esc_html__( 'Enable Video', 'alpus-core' ),
                    'type'        => Controls_Manager::SWITCHER,
                    'description' => esc_html__( 'Use video as banner background or popup.', 'alpus-core' ),
                    'condition'   => array(
                        $condition_value => 'banner',
                    ),
                    'separator'   => 'before',
            ...
            $self->start_controls_section(
                'alpus_video_section',
                array(
                    'label'     => alpus_elementor_panel_heading( esc_html__( 'Video', 'alpus-core' ) ),
                    'tab'       => Controls_Manager::TAB_LAYOUT,
                    'condition' => array(
                        $condition_value      => 'banner',
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'default' => 'youtube',
                    'options' => array(
                        'youtube'     => esc_html__( 'YouTube', 'alpus-core' ),
                        'vimeo'       => esc_html__( 'Vimeo', 'alpus-core' ),
                        'dailymotion' => esc_html__( 'Dailymotion', 'alpus-core' ),
                        'hosted'      => esc_html__( 'Self Hosted', 'alpus-core' ),
                    ),
                )
            );
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'placeholder' => esc_html__( 'Enter your URL (YouTube)', 'alpus-core' ),
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'placeholder' => esc_html__( 'Enter your URL (Vimeo)', 'alpus-core' ),
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'placeholder' => esc_html__( 'Enter your URL (Dailymotion)', 'alpus-core' ),
            ...
            $self->add_control(
                'insert_url',
                array(
                    'label'     => esc_html__( 'External URL', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'condition' => array(
                        'video_type' => 'hosted',
                    ),
            ...
            $self->add_control(
                'hosted_url',
                array(
                    'label'      => esc_html__( 'Choose File', 'alpus-core' ),
            ...
            $self->add_control(
                'external_url',
                array(
                    'label'        => esc_html__( 'URL', 'alpus-core' ),
                    ...
                    'media_type'   => 'video',
                    'placeholder'  => esc_html__( 'Enter your URL', 'alpus-core' ),
                    'condition'    => array(
                        'video_type' => 'hosted',
                        'insert_url' => 'yes',
                    ),
            ...
            $self->add_control(
                'video_mute',
                array(
                    'label' => esc_html__( 'Mute', 'alpus-core' ),
                    'type'  => Controls_Manager::SWITCHER,
                )
            );
            ...
            $self->add_control(
                'video_loop',
                array(
                    'label'     => esc_html__( 'Loop', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'condition' => array(
                        'video_type!' => 'dailymotion',
                    ),
            ...
            $self->add_control(
                'video_controls',
                array(
                    'label'     => esc_html__( 'Player Controls', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_off' => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'  => esc_html__( 'Show', 'alpus-core' ),
                    'default'   => 'yes',
                    'condition' => array(
                        'video_type!' => 'vimeo',
                    ),
            ...
            $self->add_control(
                'showinfo',
                array(
                    'label'     => esc_html__( 'Video Info', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_off' => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'  => esc_html__( 'Show', 'alpus-core' ),
                    'default'   => 'yes',
            ...
            $self->add_control(
                'modestbranding',
                array(
                    'label'     => esc_html__( 'Modest Branding', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'condition' => array(
            ...
            $self->add_control(
                'logo',
                array(
                    'label'     => esc_html__( 'Logo', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_off' => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'  => esc_html__( 'Show', 'alpus-core' ),
                    'default'   => 'yes',
            ...
            $self->add_control(
                'control_color',
                array(
                    'label'     => esc_html__( 'Controls Color', 'alpus-core' ),
            ...
            $self->add_control(
                'yt_privacy',
                array(
                    'label'       => esc_html__( 'Privacy Mode', 'alpus-core' ),
                    'type'        => Controls_Manager::SWITCHER,
                    'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'alpus-core' ),
                    'condition'   => array(
                        'video_type' => 'youtube',
                    ),
                )
            ...
            $self->add_control(
                'rel',
                array(
                    'label'     => esc_html__( 'Suggested Videos', 'alpus-core' ),
                    'type'      => Controls_Manager::SELECT,
                    'options'   => array(
                        ''    => esc_html__( 'Current Video Channel', 'alpus-core' ),
                        'yes' => esc_html__( 'Any Video', 'alpus-core' ),
                    ),
                    'condition' => array(
                        'video_type' => 'youtube',
                    ),
            ...
            $self->add_control(
                'vimeo_title',
                array(
                    'label'     => esc_html__( 'Intro Title', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_off' => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'  => esc_html__( 'Show', 'alpus-core' ),
                    'default'   => 'yes',
            ...
            $self->add_control(
                'vimeo_portrait',
                array(
                    'label'     => esc_html__( 'Intro Portrait', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_off' => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'  => esc_html__( 'Show', 'alpus-core' ),
                    'default'   => 'yes',
            ...
            $self->add_control(
                'vimeo_byline',
                array(
                    'label'     => esc_html__( 'Intro Byline', 'alpus-core' ),
                    'type'      => Controls_Manager::SWITCHER,
                    'label_off' => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'  => esc_html__( 'Show', 'alpus-core' ),
                    'default'   => 'yes',
            ...
            $self->add_control(
                'show_image_overlay',
                array(
                    'label'       => esc_html__( 'Image Overlay', 'alpus-core' ),
                    'type'        => Controls_Manager::SWITCHER,
                    'description' => esc_html__( 'Enable to show banner image as video overlay.', 'alpus-core' ),
                    'label_off'   => esc_html__( 'Hide', 'alpus-core' ),
                    'label_on'    => esc_html__( 'Show', 'alpus-core' ),
                    'separator'   => 'before',
                    'default'     => 'yes',
            ...
            $self->add_control(
                ...
                array(
                    ...
                    'type'               => Controls_Manager::SWITCHER,
                    'description'        => esc_html__( 'Enable to play video with popup.', 'alpus-core' ),
            ...
            // Section Banner Style Options
            alpus_elementor_banner_style_controls( $self, $condition_value, false );
        }
				...
				<?php } ?>
					...
					if ( settings.banner_background_image.url ) {
						addon_html += '<figure class="banner-img">' ;
							addon_html += '<img src="' + settings.banner_background_image.url + '" alt="<?php esc_attr_e( 'Banner', 'alpus-core' ); ?>">';
						addon_html += '</figure>';
					}
					...
					if ( 'yes' == settings.video_banner_switch ) {
						view.addRenderAttribute( 'video_widget_wrapper', 'class', 'elementor-element elementor-widget-video alpus-section-video' );
            ...
            if ( 'banner' == $settings['use_as'] ) {
                if ( 'yes' == $settings['video_banner_switch'] ) {
                    ...
                    if ( 'yes' == $settings['lightbox'] ) {
                        ...
                        $alpus_section['lightbox'] = $lightbox_options;
                    }
                }
            }
        ...
        public function section_addon_render( $self, $settings ) {
            if ( 'banner' == $settings['use_as'] ) { // if using as banner
                wp_enqueue_style( 'alpus-banner', alpus_core_framework_uri( '/widgets/banner/banner' . ( is_rtl() ? '-rtl' : '' ) . '.min.css' ), array(), ALPUS_CORE_VERSION );
                ...
                if ( 'yes' == $settings['parallax'] ) { // if parallax
                    ...
                    $extra_attr .= ' data-parallax-options=' . wp_json_encode( $parallax_options );
                } elseif ( 'yes' != $settings['video_banner_switch'] ) {
                    // Banner Overlay
                    if ( 'effect-' != substr( $settings['overlay'], 0, -1 ) ) {
                        $extra_class .= ' ' . alpus_get_overlay_class( $settings['overlay'] );
                    } else {
                        $extra_class .= ' overlay-wrapper';
                        $overlay_class = alpus_get_overlay_class( $settings['overlay'] );
                    }
                }
                ...
                if ( 'yes' != $settings['video_banner_switch'] && ( $settings['background_effect'] || $settings['particle_effect'] ) ) {
                    ...
                    if ( ! empty( $settings['banner_background_image'] ) ) {
                        ...
                        echo '<div class="background-effect ' . esc_attr( $background_class ) . '"' . ( ! empty( $background_img ) ? ( ' style="background-image: url(' . esc_html( $background_img ) . '); background-size: cover;">' ) : '>' );
                ...
                if ( 'banner' == $settings['use_as'] && isset( $settings['banner_background_image'] ) ) {
					...
					<figure class="banner-img">
                        ...
                        echo class_exists( 'Alpus_LazyLoad_Images' ) ? Alpus_LazyLoad_Images::add_image_placeholders( $content ) : alpus_escaped( $content );
                        ?>
					</figure>
						<?php
                        ...
                        ?>
						<figure class="banner-img">
							<?php echo '<img src="' . esc_url( $settings['banner_background_image']['url'] ) . '" alt="' . esc_attr__( 'Default Image', 'alpus-core' ) . '" width="1400" height="753"' . ( $settings['banner_background_color'] ? ( ' style="background-color:' . alpus_escaped( $settings['banner_background_color'] ) ) . '"' : '' ) . '>'; ?>
						</figure>
						<?php
                    }
                }
                ...
                if ( 'yes' == $settings['video_banner_switch'] ) {
                    ...
                    $self->add_render_attribute( 'video_widget_wrapper', 'class', 'elementor-element elementor-widget-video alpus-section-video' );
					...
					<div <?php $self->print_render_attribute_string( 'video_widget_wrapper' ); ?>>
						...
						<div <?php $self->print_render_attribute_string( 'video_wrapper' ); ?>>
                            ...
                            if ( ! $settings['lightbox'] ) {
                                echo alpus_escaped( $video_html ); // XSS ok.
                            }
                            global $alpus_section;

                    if ( $self->has_image_overlay() ) {
                        if ( ! $settings['lightbox'] && isset( $alpus_section['video_btn'] ) ) {
                        ...
                        if ( $settings['lightbox'] ) {
                            if ( ! isset( $alpus_section['video_btn'] ) ) {
                                if ( 'hosted' == $settings['video_type'] ) {
                                    $lightbox_url = $video_url;
                                } else {
                                    $lightbox_url = Embed::get_embed_url( $video_url, $embed_params, $embed_options );
                                ...
                                $lightbox_options = $alpus_section['lightbox'];
        ...
        public function register_column_addon( $addons ) {
            $addons['banner_layer'] = esc_html__( 'Banner Layer', 'alpus-core' );
        ...
        public function add_column_controls( $self, $condition_value ) {
            ...
            alpus_elementor_banner_layer_layout_controls( $self, $condition_value );
        }
        ...
        public function column_addon_content_template( $self ) {
            $is_legacy_mode_active = ! alpus_elementor_if_dom_optimization();
            ?>
			<#
 ...
 * @since 1.2.0
 */
Alpus_Section_Banner_Elementor_Widget_Addon::get_instance();

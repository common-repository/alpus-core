...
if ( ! class_exists( 'Alpus_Share' ) ) {
    ...
    class Alpus_Share extends Alpus_Base {
        ...
        public function print_social_login_content() {
            ...
            if ( ( $is_facebook_login || $is_google_login || $is_twitter_login ) && alpus_get_option( 'social_login' ) ) {
                ?>

				<div class="social-login text-center">
					<p><?php esc_html_e( 'Sign in with social account', 'alpus-core' ); ?></p>
...
if ( ! function_exists( 'alpus_print_share' ) ) {
    ...
    function alpus_print_share() {
        ...
        foreach ( $share_icons as $share ) {
            ...
            echo '<a href="' . alpus_escaped( $link ) . '" class="social-icon ' . esc_attr( $icon_type . $custom ) . ' social-' . alpus_escaped( $share ) . '" target="_blank" rel="noopener noreferrer" title="' . alpus_escaped( $social_shares[ $share ]['title'] ) . '">';

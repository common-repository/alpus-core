<?php
/**
 * Define common functions using in Alpus FrameWork
 *
 * @author     D-THEMES
 *
 * @since      1.0
...
// Breakpoints_Manager Class for alpus_get_breakpoints - function
...
if ( ! function_exists( 'alpus_get_col_class' ) ) {
    /**
     ...
     */
    function alpus_get_col_class( $col_cnt = array() ) {
        $class = ' row';
         ...
         * @since 1.0
         */
        return apply_filters( 'alpus_get_col_class', $class );
    }
}

if ( ! function_exists( 'alpus_get_slider_class' ) ) {
    /**
     ...
     */
    function alpus_get_slider_class() {
...
if ( ! function_exists( 'alpus_get_slider_status_class' ) ) {
    /**
     ...
     * @return string slider class
     */
    function alpus_get_slider_status_class( $settings = array() ) {
        $class = '';
...
if ( ! function_exists( 'alpus_get_breakpoints' ) ) {
    /**
     * Get breakpoints
     *
     * @since 1.0
     ...
     */
    function alpus_get_breakpoints( $screen_mode = '' ) {
...
if ( ! function_exists( 'alpus_add_url_parameters' ) ) {
    /**
     * Add parameters with value to url
     *
     * @since 1.0
     */
    function alpus_add_url_parameters( $url, $name, $value ) {
        ...
        return alpus_woo_widget_clean_link( $url );
    }
}

if ( ! function_exists( 'alpus_woo_widget_clean_link' ) ) {
    /**
     * Get clean link
     *
     * @since 1.0
     */
    function alpus_woo_widget_clean_link( $link ) {
        return str_replace( '#038;', '&', str_replace( '%2C', ',', $link ) );
    }
}

if ( ! function_exists( 'alpus_get_template_part' ) ) {
    /**
     ...
     */
    function alpus_get_template_part( $slug, $name = null, $args = array() ) {
        if ( ! defined( 'ALPUS_FRAMEWORK_PATH' ) ) {
            return '';
        }

        // Add ALPUS_PART to slug, if it hasn't
        if ( ALPUS_PART != substr( $slug, strlen( ALPUS_PART ) ) ) {
            $slug = ALPUS_PART . '/' . $slug;
        }
         ...
         * @since 1.0
         */
        $template = apply_filters( 'alpus_get_template_part', $template, $slug, $name );
...
if ( ! function_exists( 'alpus_get_review_pagination' ) ) {
    /**
     * Include template part
     *
     * @since 1.0
...
if ( ! function_exists( 'alpus_get_placeholder_img' ) ) {
    function alpus_get_placeholder_img( $size = 'full' ) {
        $src               = ALPUS_CORE_URI . '/assets/images/placeholder.png';
        $placeholder_image = get_option( 'alpus_placeholder_image', 0 );
         ...
         * @since 1.0
         */
        return apply_filters( 'alpus_placeholder_img_src', $src );
    }
}
 ...
 * @since 1.0
 */
if ( ! function_exists( 'alpus_register_taxonomy' ) ) {
    function alpus_register_taxonomy( $name, $object_type, $args ) {
